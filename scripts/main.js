...
class Main {
    ...
    _scrollinit() {
        ...
        this.observers = new ScrollObserver('.cover-slide', this._inviewAnimation, {rootMargin: "-150px 0px"});
        this.observers = new ScrollObserver('.tween-animate-title', this._textAnimation, {rootMargin: "-150px 0px"});
    ...
    _init() {
        ...
        // Pace.on("done", _paceDone).bind(this);
        this._scrollinit();
    }
